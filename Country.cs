...
namespace ISO3166
{
    public class Country
    {
        ...
        public static readonly Country[] List = new[]
        {
            ...
            new Country("British Indian Ocean Territory (the)", "IO", "IOT", "086"),
            ...
            new Country("Cocos (Keeling) Islands (the)", "CC", "CCK", "166"),
            new Country("Colombia", "CO", "COL", "170"),
            new Country("Comoros", "KM", "COM", "174"),
            new Country("Congo (the)", "CG", "COG", "178"),
            ...
            new Country("Falkland Islands (the) [Malvinas]", "FK", "FLK", "238"),
            new Country("Faroe Islands (the)", "FO", "FRO", "234"),
            ...
            new Country("French Southern Territories (the)", "TF", "ATF", "260"),
            ...
            new Country("Korea (the Democratic People's Republic of)", "KP", "PRK", "408"),
            ...
            new Country("Netherlands (Kingdom of the)", "NL", "NLD", "528"),
            ...
            new Country("Turks and Caicos Islands (the)", "TC", "TCA", "796"),
